      ...
      <CommandList>
        ...
        <CommandGroup heading="Quick actions">
          <CommandItem onSelect={() => go("/publish")}>
            ...
            Publish a product<CommandShortcut>N</CommandShortcut>
          </CommandItem>
        ...
        <CommandGroup heading="Navigation">
          <CommandItem onSelect={() => go("/creator/analytics")}>
            <BarChart3 className="size-4 mr-2" />
            Analytics
          </CommandItem>
          <CommandItem onSelect={() => go("/creator/revenue")}>
            <CreditCard className="size-4 mr-2" />
            Revenue & payouts
          </CommandItem>
          <CommandItem onSelect={() => go("/dashboard/notifications")}>
          ...
          <CommandItem onSelect={() => go("/creator/products")}>
