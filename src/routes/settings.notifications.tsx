...
export const Route = createFileRoute("/settings/notifications")({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Notifications — Settings" }, { property: "og:description", content: "Notification preferences." },
  ]}),
  component: () => (
    <DashboardLayout side={<SideNav items={settingsNav} title="Settings" />}>
      <div className="p-6 md:p-8 max-w-[800px] space-y-6">
        ...
        <div className="card-elegant rounded-2xl divide-y divide-border/40">
          {[
            "New sales on my products", "New reviews", "New followers", "Product updates from creators I follow",
            "Weekly summary", "Marketing emails", "Security alerts", "Payout confirmations",
          ].map((n, i) => (
