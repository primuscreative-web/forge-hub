...
export const Route = createFileRoute("/learning")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Guides, courses, and documentation to help you ship faster." },
    { property: "og:title", content: "Learning — DevForge Hub" }, { property: "og:description", content: "Guides and documentation." },
  ]}),
  component: () => {
    const lessons = [
    ...
    return (
      <SiteLayout>
        <div className="mx-auto max-w-[1440px] px-4 md:px-6 py-10">
          <PageHeader title="Learning" description="Guides, courses, and docs to help you ship faster." />
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {lessons.map((l) => (
              <div key={l.t} className="card-elegant rounded-2xl p-5 hover-lift hover:[&]:hover-lift-active cursor-pointer">
                <div className="size-10 rounded-xl gradient-brand-soft grid place-items-center mb-3"><l.i className="size-4 text-primary" /></div>
