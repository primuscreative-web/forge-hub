  ...
  head: () => ({
    meta: [
      { title: "All categories — DevForge Hub" },
      {
        name: "description",
        content:
          "Explore 70+ categories: SaaS, boilerplates, UI kits, AI agents, MCP servers, infrastructure, and more.",
      },
      { property: "og:title", content: "All categories — DevForge Hub" },
      {
        property: "og:description",
        content: "Explore 70+ categories: SaaS, boilerplates, UI kits, AI agents, and more.",
      },
    ],
  }),
...
function CategoriesPage() {
  ...
  const categoryGroups = Array.from(new Set(categories.map((category) => category.group)));
    ...
    <SiteLayout>
      <div className="mx-auto max-w-[1440px] px-4 md:px-6 py-10">
        <PageHeader
          ...
          description={`${categories.length} categories · ${products.length}+ products`}
        />
        {loading ? (
