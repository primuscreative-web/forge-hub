...
export const Route = createFileRoute("/dashboard/support")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Open a support ticket or check the status of an existing request.",
      },
  ...
  component: () => {
    const rows = [
      {
        id: "TKT-2411",
        subject: "Cannot activate license on second machine",
      ...
      {
        id: "TKT-2402",
        subject: "Question about multi-tenant setup",
        product: "AuthForge",
        status: "Resolved",
        updated: "3d ago",
      },
      {
        id: "TKT-2388",
        subject: "Refund for duplicated purchase",
      ...
      <DashboardLayout side={<SideNav items={buyerNav} title="Personal" />}>
        <div className="p-6 md:p-8 max-w-[1100px]">
          <PageHeader
            ...
            description="3 tickets total · 1 open"
            actions={
