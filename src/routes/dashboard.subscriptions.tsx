...
export const Route = createFileRoute("/dashboard/subscriptions")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage your active subscriptions across purchased products.",
      },
          ...
          <DataTable
            ...
            columns={[
              ...
              },
              {
                key: "price",
                header: "Price",
                render: (r) => <span className="text-sm">${r.price}/mo</span>,
              },
              {
                key: "renews",
                header: "Renews",
                render: (r) => <span className="text-sm text-muted-foreground">{r.renews}</span>,
              },
