    ...
    <DashboardLayout side={<SideNav items={adminNav} title="Admin" />}>
      <div className="p-6 md:p-8 max-w-[900px]">
        <PageHeader
          ...
          actions={<Button className="gradient-brand text-white">Save changes</Button>}
        />
        <div className="card-elegant rounded-2xl divide-y divide-border/40">
          {[
            {
              title: "Platform fee",
              desc: "Percentage taken from each sale.",
              ctrl: <Input defaultValue="10%" className="w-24 bg-surface-1" />,
            },
            {
              title: "Payout schedule",
              desc: "How often creators are paid.",
              ctrl: <Input defaultValue="Monthly" className="w-40 bg-surface-1" />,
            },
            {
              title: "Default currency",
              desc: "Base currency for pricing.",
              ctrl: <Input defaultValue="USD" className="w-24 bg-surface-1" />,
            },
            {
              title: "Support email",
              desc: "Public support address.",
              ctrl: <Input defaultValue="support@devforge.hub" className="w-64 bg-surface-1" />,
            },
            {
              title: "Allow anonymous browsing",
              desc: "Let visitors browse without an account.",
              ctrl: <Switch defaultChecked />,
            },
            {
