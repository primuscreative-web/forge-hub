...
export const Route = createFileRoute("/settings/billing")({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Billing — Settings" }, { property: "og:description", content: "Manage billing on DevForge Hub." },
  ]}),
  component: () => (
    <DashboardLayout side={<SideNav items={settingsNav} title="Settings" />}>
      <div className="p-6 md:p-8 max-w-[900px] space-y-6">
        ...
        <div className="card-elegant rounded-2xl p-6 flex items-center justify-between">
          ...
          <div className="flex gap-2"><Button variant="outline">Change plan</Button><Button variant="ghost" className="text-destructive">Cancel</Button></div>
        </div>
        <div className="card-elegant rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 rounded-xl border border-border/60 p-4">
            <div className="size-10 rounded-lg bg-surface-2 grid place-items-center"><CreditCard className="size-4" /></div>
