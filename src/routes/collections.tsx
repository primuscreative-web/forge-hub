...
const m = (t: string, d: string) => ({
  meta: [
    { title: `${t} — DevForge Hub` },
    { name: "description", content: d },
    { property: "og:title", content: `${t} — DevForge Hub` },
...
export const Route = createFileRoute("/collections")({
  ...
  component: () => {
    const cols = [
      {
        name: "Launch-a-SaaS pack",
        desc: "Everything to launch a SaaS in a weekend.",
        items: [0, 1, 4, 10],
        tag: "Bundle · $299",
      },
      {
        name: "AI toolkit essentials",
        desc: "MCP servers, agents, prompts, and rules.",
        items: [2, 6, 7, 15],
        tag: "Bundle · $199",
      },
      {
        name: "Design system starter",
        desc: "UI kit, icons, and Figma library.",
        items: [3, 8, 19],
        tag: "Bundle · $149",
      },
      {
        name: "Cloud infra stack",
        desc: "K8s, Terraform, Cloudflare templates.",
        items: [9, 5, 27],
        tag: "Bundle · $349",
      },
    ];
    return (
      <SiteLayout>
        <div className="mx-auto max-w-[1440px] px-4 md:px-6 py-10">
          <PageHeader
            title="Collections"
            description="Curated bundles from DevForge Hub creators."
          />
              ...
              <div key={c.name} className="card-elegant rounded-2xl overflow-hidden">
                <div className="grid grid-cols-4 gap-0.5 aspect-[16/6]">
                  {c.items.slice(0, 4).map((i) => (
                    <div
                      ...
                      style={{ background: products[i].gradient }}
                    >
                      {products[i].emoji}
                    </div>
                  ))}
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Badge className="gradient-brand text-white border-transparent shrink-0">
                      {c.tag}
                    </Badge>
                  </div>
