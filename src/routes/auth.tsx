            ...
            <Tabs defaultValue="signin">
              ...
              <TabsContent value="signin" className="space-y-4 mt-6">
                ...
                <div className="space-y-2">
                  <Label>Email</Label>
                  <Input type="email" placeholder="you@company.com" className="bg-surface-1" />
                </div>
                <div className="space-y-2">
                ...
                <Button asChild className="w-full gradient-brand text-white hover:opacity-90 h-11">
              ...
              <TabsContent value="signup" className="space-y-4 mt-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Ada" className="bg-surface-1" />
                  </div>
                  <div className="space-y-2">
                    <Label>Last name</Label>
                    <Input placeholder="Lovelace" className="bg-surface-1" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label>Email</Label>
                ...
                <Button asChild className="w-full gradient-brand text-white h-11">
