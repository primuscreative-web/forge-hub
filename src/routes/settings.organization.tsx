...
export const Route = createFileRoute("/settings/organization")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Organization — Settings" },
      { property: "og:description", content: "Manage your organization on DevForge Hub." },
    ],
  }),
  component: () => (
      ...
      <div className="p-6 md:p-8 max-w-[900px] space-y-6">
        ...
        <div className="card-elegant rounded-2xl p-6 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-sm font-medium">Acme Labs</div>
              <div className="text-xs text-muted-foreground">acme-labs · Enterprise plan</div>
            </div>
          </div>
