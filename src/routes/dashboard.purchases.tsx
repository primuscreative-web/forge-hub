      ...
      <DashboardLayout side={<SideNav items={buyerNav} title="Personal" />}>
        <div className="p-6 md:p-8 max-w-[1400px]">
          <PageHeader
            ...
            description="18 orders · $2,140 spent lifetime"
            actions={<Button variant="outline">Export all invoices</Button>}
          />
          <DataTable
            rows={rows}
            columns={[
              ...
              },
              {
                key: "invoice",
                header: "Invoice",
                render: (r) => <code className="text-xs">{r.invoice}</code>,
              },
              {
                key: "date",
                header: "Date",
              ...
              },
              {
                key: "amount",
                header: "Amount",
                render: (r) => <span className="text-sm font-medium">${r.price}</span>,
              },
